      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {topReaders.map((reader, index) => (
            <div
              key={reader.id}
              className={`reader-card relative bg-white dark:bg-[#1f1f1f] rounded-2xl shadow-xl overflow-hidden border border-slate-200 dark:border-[#303030] transform transition-all hover:scale-105 ${
        ...
        <div className="challenge-cta text-center mt-12">
          <div className="bg-white dark:bg-[#1f1f1f] text-slate-900 dark:text-white rounded-2xl border border-slate-200 dark:border-[#303030] shadow-[0_1px_2px_0_rgba(0,0,0,0.03)] p-8 max-w-2xl mx-auto">
