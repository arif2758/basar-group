...
const HeroGranthagar: React.FC = () => {
  ...
  return (
    <div ref={heroRef} className="text-slate-900 dark:text-white transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <div className="hero-quote bg-white dark:bg-[#1f1f1f] border border-slate-200 dark:border-[#303030] rounded-2xl p-6 mb-8 max-w-3xl mx-auto shadow-[0_1px_2px_0_rgba(0,0,0,0.03)]">
          ...
          <div className="hero-buttons flex flex-col sm:flex-row gap-3 justify-center mb-12">
            ...
            <a href="/granthagar/books" className="inline-flex items-center justify-center bg-white dark:bg-[#1f1f1f] hover:bg-slate-50 dark:hover:bg-[#262626] text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-[#303030] px-8 py-3.5 rounded-xl font-medium text-base transition-all shadow-sm">
              বই খুঁজুন (Search Books)
            </a>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <div className="hero-stat text-center bg-white dark:bg-[#1f1f1f] p-5 rounded-2xl border border-slate-200 dark:border-[#303030] shadow-[0_1px_2px_0_rgba(0,0,0,0.03)]">
