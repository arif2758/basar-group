...
const NAV_ITEMS = [
  { name: "ওভারভিউ", href: "/it-park", icon: LayoutDashboard, exact: true, color: "text-blue-500" },
  { name: "প্রযুক্তি কোর্স ও বুটক্যাম্প", href: "/it-park/courses", icon: GraduationCap, color: "text-sky-500", badge: "ভর্তি চলছে" },
  { name: "আইটি জব বোর্ড ও ক্যারিয়ার", href: "/it-park/jobs", icon: Briefcase, color: "text-emerald-500", badge: "নতুন জব" },
  { name: "সেমিনার ও ইভেন্ট", href: "/it-park/events", icon: Calendar, color: "text-amber-500" },
  { name: "কো-ওয়ার্কিং স্পেস", href: "/it-park/coworking", icon: Building2, color: "text-purple-500" },
  { name: "অভিভাবক গাইড", href: "/it-park/guardian", icon: Shield, color: "text-rose-500" },
];

export default function ITSubNav() {
                    ...
                    <span
                      className={cn(
                        ...
                        isActive
                          ...
                          : "bg-blue-100 dark:bg-[#112a45] text-blue-700 dark:text-[#1677ff] border border-blue-200 dark:border-[#153450]"
                      )}
                    >
                      {item.badge}
                    </span>
