  ...
  if (!mounted) {
    return (
      <button
        ...
        className={`relative inline-flex items-center justify-center h-9 w-9 rounded-full border border-slate-200 dark:border-[#303030] bg-transparent text-slate-400 opacity-60 cursor-default ${className}`}
      >
