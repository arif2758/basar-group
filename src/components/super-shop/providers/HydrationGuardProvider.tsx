...
export default function HydrationGuardProvider({
  ...
  if (!mounted) {
    return (
      <div className="min-h-screen bg-[#f5f5f5] dark:bg-[#141414] p-0 space-y-0 animate-in fade-in duration-700">
        {/* Navbar Skeleton - Matches NavbarClient (h-14) */}
        <div className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-[#141414] h-14 border-b border-slate-200 dark:border-[#303030]">
