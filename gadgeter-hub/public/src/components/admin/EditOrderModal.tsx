...
export function EditOrderModal({ order, products }: Props) {
  ...
  const initialItems: EditOrderItem[] = order.items.map((it) => {
    const pId = String(
      ...
      typeof it.product === "object" && it.product !== null
        ? (it.product as any)._id || it.product
        : it.product || products[0]?._id || "",
    );
    ...
    setItems((prev) => [
      {
        ...
        quantity: 1,
        unitPrice:
          defaultProduct?.salePrice || defaultProduct?.regularPrice || 0,
      },
      ...prev,
    ]);
  };
  ...
  const handleSubmit = async () => {
    ...
    if (items.length === 0)
      return toast.error("কমপক্ষে একটি প্রোডাক্ট যোগ করুন");
        ...
        <div className="space-y-5 pt-3">
            ...
            <Flex align="center" justify="space-between" wrap="wrap" gap={8}>
              <Flex align="center" gap={8}>
                <Text strong style={{ fontSize: "13px" }}>
                  <ShoppingCartOutlined style={{ color: "#1677ff" }} /> কার্ট
                            ...
                            suffix={
                              <div
                                style={{
                                  ...
                                  alignItems: "center",
                                  visibility:
                                    prod && item.productTitle !== prod.title
                                      ? "visible"
                                      : "hidden",
                                }}
                              >
                      ...
                      >
                        <div>
                          ...
                          <InputNumber
                            ...
                            min={0}
                            onChange={(val) =>
                              handleUpdateItem(idx, "unitPrice", val || 0)
                            }
          ...
          <div className="space-y-2">
            ...
            >
              <span style={{ fontSize: "12px", fontWeight: 700 }}>
                <GiftOutlined style={{ color: "#eb2f96" }} /> এটি একটি উপহার
                অর্ডার (Gift Order)
              </span>
            </Checkbox>
            {isGift && (
          ...
          <div className="space-y-2">
            <Flex align="center" justify="space-between">
              <Text strong style={{ fontSize: "12px" }}>
                <EnvironmentOutlined style={{ color: "#1677ff" }} /> ডেলিভারি
                ঠিকানা ও জোন
              </Text>
              <Text
                type="secondary"
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-1">
                ...
                >
                  ISD (Inside Dhaka) — ৳
                  {calculateShippingCost("dhaka", totalWeightGrams)}
                </Radio.Button>
                <Radio.Button
                  value="suburbs"
                  style={{
                ...
                >
                  SUB (Suburbs) — ৳
                  {calculateShippingCost("suburbs", totalWeightGrams)}
                </Radio.Button>
                <Radio.Button
                  value="outside"
                  style={{
                ...
                >
                  OSD (Outside Dhaka) — ৳
                  {calculateShippingCost("outside", totalWeightGrams)}
                </Radio.Button>
              </div>
            </Radio.Group>
          </div>
          ...
          {/* Summary & Save */}
          <Card
            style={{ background: "#0f172a", borderRadius: 16, marginTop: 16 }}
          ...
          >
            <div style={{ textAlign: "center" }}>
              ...
              >
                ...
                {vipPrivilege > 0 &&
                  ` - VIP Honor ${formatPrice(vipPrivilege)}`}
