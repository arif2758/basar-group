...
export function AdminProductsAntdClient({
  ...
  const outOfStockCount = initialProducts.filter(
    (p) => p.stockQuantity <= 0,
  ).length;
  ...
  const filteredProducts = initialProducts.filter((product) => {
    // Status filter
    if (statusFilter === "published" && product.status === "draft")
      return false;
  ...
  const columns: ColumnsType<IProduct> = [
    ...
    },
    {
      ...
      render: (_, record) => {
        const categoryData =
          record.category as unknown as CategoryOption | null;
        return (
          <div style={{ maxWidth: 300 }}>
            ...
            <Flex align="center" gap={6} style={{ marginTop: 4 }}>
              ...
              <Tag
                color="blue"
                style={{ fontSize: "10px", margin: 0, borderRadius: 6 }}
              >
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        const hasDiscount =
          (record.salePrice || 0) > 0 &&
          (record.salePrice || 0) < record.regularPrice;
        return (
          <div>
      ...
      <div className="flex flex-col gap-3.5 md:hidden">
        {filteredProducts.length > 0 ? (
          filteredProducts.map((product) => {
            const categoryData =
              product.category as unknown as CategoryOption | null;
                  ...
                  >
                    ...
                    <Space size="small">
                      ...
                      <Popconfirm
                        ...
                        okButtonProps={{
                          danger: true,
                          loading: deletingId === String(product._id),
                        }}
                      >
                        <Button size="small" danger icon={<DeleteOutlined />} />
                      </Popconfirm>
