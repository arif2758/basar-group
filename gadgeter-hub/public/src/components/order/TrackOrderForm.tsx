      ...
      >
        <div className="space-y-2 text-center mb-4">
          ...
          <p className="text-xs text-slate-500 font-medium">
            অর্ডার আইডি বা মোবাইল নম্বর যেকোনো স্টাইলে ইনপুট দিয়ে লাইভ স্ট্যাটাস
            দেখুন
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200/80 space-y-2">
            ...
            <ul className="text-[11px] font-medium text-slate-600 space-y-1.5 pl-6 list-disc">
              <li>
                <strong className="text-slate-900">ইনভয়েস ID দিয়ে:</strong>{" "}
                যেমন{" "}
              ...
              <li>
                <strong className="text-slate-900">
                  সংক্ষিপ্ত নম্বর দিয়ে:
                </strong>{" "}
                ড্যাশ, স্পেস বা স্মল লেটারেও লিখতে পারেন (যেমন:{" "}
              ...
              <li>
                <strong className="text-slate-900">ফোন নম্বর দিয়ে:</strong>{" "}
                অর্ডার করার সময় ব্যবহৃত আপনার{" "}
                ...
                <p className="font-bold text-slate-900">
                  {[
                    ...
                    .filter(
                      (p): p is string =>
                        Boolean(p) &&
                        !/outside dhaka|inside dhaka|^dhaka$/i.test(p!.trim()),
                    )
