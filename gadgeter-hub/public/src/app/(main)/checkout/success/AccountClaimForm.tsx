  ...
  const onSubmit = async (data: ClaimValues) => {
    ...
    try {
      ...
      if (signInResult?.error) {
        toast.error(
          "স্বয়ংক্রিয়ভাবে লগিন হতে সমস্যা হয়েছে, অনুগ্রহ করে লগিন করুন।",
        );
        router.push("/login");
      } else {
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            ভবিষ্যতে এক ক্লিকে অর্ডার করতে এবং সব অর্ডারের স্ট্যাটাস দেখতে আপনার
            ইমেইল দিয়ে একটি পাসওয়ার্ড সেট করুন।
          </p>
        </div>
      </div>
