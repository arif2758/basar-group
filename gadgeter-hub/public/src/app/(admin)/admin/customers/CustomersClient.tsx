  ...
  const columns: ColumnsType<CustomerDirectoryItem> = [
    ...
    },
    {
      ...
      render: (val, record) => (
        <div>
          <Tag
            color="cyan"
            style={{ fontWeight: 900, fontSize: "12px", borderRadius: 6 }}
          >
            {val}টি অর্ডার
          </Tag>
          <Text
            type="secondary"
            style={{ display: "block", fontSize: "10px", marginTop: 2 }}
          >
            {record.deliveredCount} সাকসেস{" "}
            {record.returnedCount > 0 && `· ${record.returnedCount} রিটার্ন`}
          </Text>
        </div>
      ),
    },
    ...
    },
    {
      ...
      render: (val) => (
        <Text
          type="secondary"
          style={{ fontSize: "12px", maxWidth: 220, display: "block" }}
        >
          {val || "N/A"}
        </Text>
      ),
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        >
          ...
          <Title
            level={3}
            style={{ margin: "4px 0 0", fontWeight: 900, color: "#0f172a" }}
          >
            {customers.length} জন
          </Title>
        </Card>
        ...
        >
          ...
          <Title
            level={3}
            style={{ margin: "4px 0 0", fontWeight: 900, color: "#d97706" }}
          >
            {vipCount} জন
          </Title>
        </Card>
        ...
        >
          ...
          <Title
            level={3}
            style={{ margin: "4px 0 0", fontWeight: 900, color: "#2563eb" }}
          >
            {repeatCount} জন
          </Title>
        </Card>
