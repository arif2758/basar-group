...
export function FinanceClient({
  ...
  const [statusFilter, setStatusFilter] = useState<
    "delivered_only" | "all_orders"
  >("all_orders");
  const [sortBy, setSortBy] = useState<
    "universal" | "profit" | "roi" | "sales"
  >("universal");
  ...
  const [isSubmittingExpense, setIsSubmittingExpense] =
  ...
  const getFilterDates = () => {
    ...
    if (dateRangePreset === "yesterday") {
      ...
      return {
        startDate: yest.format("YYYY-MM-DD"),
        endDate: yest.format("YYYY-MM-DD"),
      };
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 sm:mb-6 text-center sm:text-left">
        <div>
          ...
          <Text type="secondary" style={{ fontSize: "12px" }}>
            Real-time revenue, 1% courier collection fee, ad spend, ROI % and
            Net Profit.
          </Text>
        </div>
      ...
      <Row gutter={[12, 12]}>
        ...
        <Col xs={12} sm={12} md={8} lg={4.8}>
          ...
          >
            ...
            <Title
              level={3}
              style={{ margin: "4px 0 0", color: "#0f172a", fontWeight: 900 }}
            >
        ...
        <Col xs={12} sm={12} md={8} lg={4.8}>
          ...
          >
            ...
            <Title
              level={3}
              style={{ margin: "4px 0 0", color: "#64748b", fontWeight: 900 }}
            >
        ...
        <Col xs={12} sm={12} md={8} lg={4.8}>
          ...
          >
            ...
            <Title
              level={3}
              style={{ margin: "4px 0 0", color: "#d97706", fontWeight: 900 }}
            >
        ...
        <Col xs={12} sm={12} md={8} lg={4.8}>
          ...
          >
            ...
            <Title
              level={3}
              style={{ margin: "4px 0 0", color: "#7c3aed", fontWeight: 900 }}
            >
      ...
      <Card style={{ borderRadius: 16 }} styles={{ body: { padding: 16 } }}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mb-4 text-center sm:text-left">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-2.5">
            ...
            <div>
              ...
              >
                Rank products by Universal Score, Net Profit, ROI %, or Sales
                Volume
              </Text>
            </div>
          </div>
        ...
        <div
          className={`block md:hidden space-y-3.5 transition-opacity duration-200 ${loading ? "opacity-50 pointer-events-none" : "opacity-100"}`}
        >
                ...
                <div className="grid grid-cols-4 gap-1.5 pt-2 border-t border-slate-100 text-center items-center">
                  ...
                  <div className="bg-slate-50 p-1.5 rounded-lg">
                    ...
                    <p className="text-xs font-bold text-purple-600">
                      {formatPrice(item.attributedAdSpend)}
                    </p>
                  </div>
                  <div className="bg-slate-50 p-1.5 rounded-lg">
                    <p className="text-[9px] text-slate-400 font-semibold uppercase">
                    ...
                    <p
                      className={`text-xs font-black ${item.netProfit >= 0 ? "text-emerald-600" : "text-red-500"}`}
                    >
          ...
          <Table
            ...
            columns={[
              ...
              },
              {
                ...
                align: "right",
                render: (val) => (
                  <Text style={{ color: "#7c3aed" }}>{formatPrice(val)}</Text>
                ),
              },
              {
                title: "Profit",
              ...
              },
              {
                ...
                render: (val) => (
                  <Tag
                    color={val >= 100 ? "green" : val > 0 ? "blue" : "red"}
      ...
      <Card style={{ borderRadius: 16 }} styles={{ body: { padding: 16 } }}>
        ...
        {/* Mobile Cards View (block md:hidden) */}
        <div
          className={`block md:hidden space-y-3 transition-opacity duration-200 ${loading ? "opacity-50 pointer-events-none" : "opacity-100"}`}
        >
          {expenses.length === 0 ? (
            <div className="text-center py-12 text-slate-400 text-xs font-medium bg-slate-50 rounded-2xl border border-dashed border-slate-200">
            ...
            expenses.map((record) => {
              const cat =
                CATEGORY_LABELS[record.category] || CATEGORY_LABELS.other;
              return (
                <div
                  key={record._id}
      ...
      >
        ...
        >
          ...
          >
            <Input
              placeholder="যেমন: ফেসবুক এড চার্জ আগস্ট ৪ / বাবল র‍্যাপ ক্রয়"
          ...
          <Form.Item
            ...
            label={
              <Text strong>
                নির্দিষ্ট প্রোডাক্টের সাথে লিঙ্ক করুন (Optional)
              </Text>
            }
          ...
          <Form.Item
            name="note"
            label={<Text strong>নোট / মন্তব্য (Optional)</Text>}
          >
            <Input.TextArea
              rows={2}
