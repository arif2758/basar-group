...
export function InventoryClient({
  ...
  const [activeOrdersCount, setActiveOrdersCount] =
    useState<number>(initialActiveOrders);
  ...
  const [outOfStockCount, setOutOfStockCount] =
    useState<number>(initialOutOfStock);
  ...
  const handleUpdateStock = async (
    ...
    const newQty =
      editingStockMap[editKey] !== undefined
        ? editingStockMap[editKey]
        : currentQty;
          ...
          prev.map((prod) => {
            if (prod._id === productId) {
              if (variantId && prod.hasVariants) {
                ...
                const total = updatedVariants.reduce(
  ...
  const filteredMatrix = matrix.filter((item) => {
    ...
    if (stockFilter === "low")
      return item.totalStock > 0 && item.totalStock <= 5;
  ...
  return (
    <div className="space-y-4 pb-12">
      ...
      <Flex
        ...
        wrap="wrap"
        gap={12}
        className="bg-white p-4 rounded-2xl shadow-xs border border-slate-200"
      >
        <div>
          <Title
            level={4}
            style={{ margin: 0, fontWeight: 900, color: "#0f172a" }}
          >
            📦 Smart Inventory & Warehouse Pick List
          </Title>
          <Text type="secondary" style={{ fontSize: "12px" }}>
            আজকের প্যাকিং লিস্ট, গোডাউন রিকুইজিশন এবং ১-ক্লিক ভ্যারিয়েন্ট স্টক
            কন্ট্রোল
          </Text>
        </div>
        ...
        <Col xs={12} sm={6}>
          ...
          >
            <Statistic
              ...
              value={totalUnits}
              styles={{
                content: { color: "#1677ff", fontWeight: 900, fontSize: 22 },
              }}
        ...
        <Col xs={12} sm={6}>
          ...
          >
            <Statistic
              ...
              styles={{
                content: { color: "#6366f1", fontWeight: 900, fontSize: 22 },
              }}
              suffix={
        ...
        <Col xs={12} sm={6}>
          ...
          >
            <Statistic
              ...
              value={lowStockCount}
              styles={{
                content: { color: "#d97706", fontWeight: 900, fontSize: 22 },
              }}
        ...
        <Col xs={12} sm={6}>
          ...
          >
            <Statistic
              ...
              styles={{
                content: { color: "#dc2626", fontWeight: 900, fontSize: 22 },
              }}
        ...
        {activeTab === "picklist" && (
          <div className="space-y-4 pt-2">
            <Flex align="center" justify="space-between" wrap="wrap" gap={8}>
              ...
              >
                আজকের পন্ডিং/প্রসেসিং/রেডি অর্ডারের প্রোডাক্ট অনুযায়ী মোট
                প্রয়োজনীয় পরিমাণ:
              </Text>
              <Button
                size="small"
            ...
            {isLoadingPickList ? (
              <div className="text-center py-12">
                ...
                <div className="text-slate-400 text-xs mt-2">
                  পিক-লিস্ট ক্যালকুলেট হচ্ছে...
                </div>
              </div>
            ) : pickList.length === 0 ? (
              <div className="text-center py-12 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                <CheckCircleOutlined
                  style={{ fontSize: 36, color: "#22c55e" }}
                />
                <div className="text-slate-700 font-bold text-sm mt-2">
                  আজকে পিক করার মতো কোনো পেন্ডিং অর্ডার নেই!
                </div>
                <div className="text-slate-400 text-xs mt-1">
                  সব শিপমেন্ট প্রসেসড অথবা প্রস্তুত রয়েছে।
                </div>
              </div>
            ) : (
          ...
          <div className="space-y-4 pt-2">
            ...
            {isLoadingMatrix ? (
              <div className="text-center py-12">
                <Spin size="large" />
                <div className="text-slate-400 text-xs mt-2">
                  স্টক মেটাবোলিজম ডাটা লোড হচ্ছে...
                </div>
              </div>
                          ...
                          <div className="pt-2 border-t border-slate-100 space-y-2">
                            ...
                            >
                              ...
                              >
                                ...
                                <span>
                                  🎨 ভ্যারিয়েন্ট স্টক সমূহের তালিকা (
                                  {prod.variants.length} টি)
                                </span>
                                {hasCriticalVariant && (
                                  <Tag
                                    color="error"
