...
import {
  EditOrderModal,
  ProductOption,
} from "../../../../../components/admin/EditOrderModal";
import {
  ShareAltOutlined,
  CarOutlined,
  SaveOutlined,
...
export function OrderDetailsClient({ order, products = [] }: Props) {
  ...
  const [courierStatusState, setCourierStatusState] = useState(
    order.courierStatus || "",
  );
  const [courierReasonState, setCourierReasonState] = useState(
    order.courierReason || "",
  );
  const [courierAttemptState, setCourierAttemptState] = useState(
  ...
  const addressParts = [
    ...
    (p): p is string =>
      Boolean(p) &&
      !/suburbs|suburb|outside dhaka|inside dhaka|^dhaka$/i.test(p!.trim()),
  );
  ...
  const courierText =
    ...
    (effectiveVipPrivilege > 0
      ? `VIP Privilege: -${effectiveVipPrivilege}\n`
      : "") +
  ...
  return (
    <div style={{ padding: 0 }} className="space-y-5">
        ...
        <div className="space-y-4">
                      ...
                      menu={{
                        items: [
                          ...
                          },
                          {
                            ...
                            icon: <CopyOutlined />,
                            onClick: () =>
                              handleCopy(order.shipping.phone, "phone_top"),
                          },
                        ],
                      }}
          ...
          {isInReturn ? (
            <div className="p-3 my-2 bg-red-50 border border-red-400 rounded-xl text-center text-red-700 font-bold text-xs flex items-center justify-center gap-2">
              ...
              <span>
                🚚 অর্ডারটি কুরিয়ার থেকে রিটার্ন ফেরত আসছে (In-Return Transit)।
                অফিসে পৌঁছালে '📦 Returned' সিলেক্ট করুন।
              </span>
            </div>
      ...
      <Card
        ...
        className="border border-red-100 bg-gradient-to-r from-slate-50 to-red-50/20 shadow-sm"
      >
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="divide-y divide-slate-100">
                {order.items.map((item, idx) => (
                  <div
                    key={idx}
                    className="p-4 flex gap-3 sm:gap-4 items-center"
                  >
                    <div
                      style={{
                        width: 64,
                    ...
                    <div style={{ textAlign: "right", flexShrink: 0 }}>
                      ...
                      <Text
                        strong
                        style={{ fontSize: "15px", color: "#1677ff" }}
                      >
                        {formatPrice(item.unitPrice * item.itemQuantity)}
                      </Text>
                    </div>
                ...
                <div className="space-y-2 max-w-sm ml-auto">
                  ...
                  >
                    <Flex justify="space-between" align="center">
                      ...
                      >
                        {order.advancePaid && order.advancePaid > 0
                          ? "Net COD Collection Total:"
                          : "Customer Payable Total:"}
                      </Text>
                      <Title
                        level={4}
                        style={{ color: "#ffffff", margin: 0, fontWeight: 900 }}
                      >
                        {formatPrice(
            ...
            {order.customerNotes && (
              <Alert
                ...
                showIcon
                title={
                  <Text strong style={{ color: "#78350f" }}>
        ...
        <Col xs={24} lg={9}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4">
            ...
            >
              ...
              {isGiftOrder && (
                ...
                >
                  ...
                  >
                    <GiftOutlined style={{ color: "#eb2f96" }} /> Gift Sender
                    Phone:
                  </Text>
                  <Flex align="center" gap={6}>
            ...
            >
              <Descriptions column={1} size="small" layout="horizontal">
                <Descriptions.Item
                  label={<Text type="secondary">Payment Method</Text>}
                >
                  <Tag
                    color={
                      order.paymentMethod === "cod" ? "default" : "magenta"
                    }
                ...
                <Descriptions.Item
                  label={<Text type="secondary">Payment Status</Text>}
                >
                  <Tag
                ...
                {order.paymentMethod === "mobile" && (
                  <>
                    {order.senderNumber && (
                      <Descriptions.Item
                        label={<Text type="secondary">Sender Phone</Text>}
                      >
                    ...
                    {order.transactionId && (
                      <Descriptions.Item
                        label={<Text type="secondary">TrxID</Text>}
                      >
                        <Flex align="center" gap={6}>
