...
export function InvoiceClient({ order }: Props) {
  ...
  return (
    <>
      ...
      >
        💡 <strong>Tip:</strong> Print dialog-এ Paper size <strong>A5</strong>,
        Margins <strong>None</strong>, Background graphics{" "}
      </div>
          ...
          <div className="invoice-content">
            ...
            <section className="invoice-info-grid !py-10">
              <div className="invoice-info-col">
                ...
                <div className="invoice-info-row">
                  <span className="invoice-label">Total Items:</span>{" "}
                  {totalItems}
                </div>
              </div>
              ...
              <div className="invoice-info-col">
                ...
                <div className="invoice-info-row">
                  ...
                  <span className="highlight-yellow">{zoneCode}</span> (
                  {zoneFullName})
                </div>
                <div className="invoice-info-row">
                    ...
                    <>
                      ...
                      {vipDeduction > 0 && (
                        <tr>
                          <td
                            colSpan={2}
                            className="summary-label highlight-yellow"
                            style={{ color: "#d97706" }}
                          >
                            VIP Privilege
                          </td>
                          <td
                            className="summary-value highlight-yellow"
                            style={{ color: "#d97706" }}
                          >
                            -{vipDeduction}
                          </td>
            ...
            <p className="invoice-words">
              কথায়:{" "}
              {nWords(Math.max(0, order.total - (order.advancePaid || 0)))} টাকা
              মাত্র।
            </p>
