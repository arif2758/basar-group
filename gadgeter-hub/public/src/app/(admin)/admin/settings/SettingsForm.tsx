    ...
    <div className="space-y-5">
      <div>
        ...
        <Text type="secondary" style={{ fontSize: "13px" }}>
          Configure global e-commerce variables, logistics, and system
          preferences.
        </Text>
      </div>
        ...
        >
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item
                name="storePhone"
                label={<Text strong>Customer Support Phone</Text>}
              >
                <Input
                  size="large"
        ...
        >
          <Row gutter={[16, 16]}>
            <Col xs={24} sm={12}>
              <Form.Item
                name="facebookURL"
                label={<Text strong>Facebook Page URL</Text>}
              >
                <Input
                  size="large"
            ...
            <Col xs={24} sm={12}>
              <Form.Item
                name="instagramURL"
                label={<Text strong>Instagram Profile URL</Text>}
              >
                <Input
                  size="large"
