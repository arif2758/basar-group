          ...
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} sm={12}>
              ...
              >
                <Input
                  size="large"
                  placeholder="e.g. APP-AIRPODS-PRO2"
                  style={{ borderRadius: 10 }}
                />
              </Form.Item>
            </Col>
            ...
            <Col xs={24} sm={12}>
              <Form.Item
                name="brand"
                label={<Text strong>Brand (Optional)</Text>}
              >
                <Input
                  size="large"
        ...
        >
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} sm={6}>
              <Form.Item
                name="salePrice"
                label={<Text strong>Sale Price (৳)</Text>}
              >
                <InputNumber
                  size="large"
                  min={0}
            ...
            <Col xs={24} sm={6}>
              <Form.Item
                ...
                extra="ROI ও নিট লাভ হিসেব করতে"
              >
                <InputNumber
                  size="large"
                  min={0}
